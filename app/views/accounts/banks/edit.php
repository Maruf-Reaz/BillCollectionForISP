                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="card-body">
                                    <div class="card-header card-header-primary">
                                        <h4 class="card-title"><i class="fa fa-pencil-alt"></i>Edit Bank</h4>
                                    </div>
                                    <form action="<?php URLROOT; ?>/accounts/banks/edit" method="post"
                                          class="form-horizontal" id="register-form">
                                        <div class="form-group">
                                            <div class="input-group-addon2">Name</div>
                                            <div class="input-group">
                                                <input type="text" id="bank_name" name="bank_name"
                                                       placeholder="Edit Name of Bank..." class="form-control"
                                                       required value="<?php echo $data['bank']->bank_name; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="account_number" name="account_number"
                                                       placeholder="Edit Account Number..." class="form-control"
                                                       required value="<?php echo $data['bank']->account_number; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group-addon2">Opening Date</div>
                                            <div class="input-group">
                                                <input type="text" id="opening_date" name="opening_date"
                                                       class="form-control datepicker" readonly
                                                       required value="<?php echo $data['bank']->opening_date; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group-addon2">Note</div>
                                            <div class="input-group">
                                                <input type="text" id="note" name="note" placeholder="Edit Note..."
                                                       class="form-control" value="<?php echo $data['bank']->note; ?>">
                                            </div>
                                        </div>
