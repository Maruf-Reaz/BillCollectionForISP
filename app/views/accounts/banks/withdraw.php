                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="drop-shadow x_panel au-card au-card--no-pad m-b-40">
                                <div class="card-body">
                                    ...
                                    <form action="<?php URLROOT; ?>/accounts/banks/withdraw" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" id="previous_balance" name="previous_balance"
                                                       value="<?php echo $data['previous_balance']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script>
    $(document).ready(function () {
        $('input.withdrawButton').click(function () {
            $.confirm({
                html: true,
            ...
            $("#register-form").validate({
                rules: {
                    amount: {
                        required: true,
                        pattern: /^[0-9]+(?:\.[0-9]{1,5})?$/,
                        max: parseFloat($('#previous_balance').val())
                    },
                    bank_id: {
                        required: true
                    },
