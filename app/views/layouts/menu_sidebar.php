    ...
    <div class="logo">
        <a style="padding-top: 13px;" href="<?php echo URLROOT; ?>/">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                 ...
                 style="enable-background:new 0 0 886 317.9;width: 100px; margin-left: 28px;margin-top: 5px;"
                 xml:space="preserve">
                <style type="text/css">
                    .st0 {
                        fill: #85CE36;
    ...
    <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
            <ul class="nav-left list-unstyled navbar__list">
                ...
                <li class="has-sub">
                    <a class="js-arrow">
                        <i style="width: 20px" class="fas fa-user-friends"></i>Subscriber<span
                                class="fa fa-chevron-down"
                                style="float: right;padding-right: 14px;"></span></a>
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        <li>
                            <a href="<?php echo URLROOT; ?>/Subscribers/index">All Subscriber</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT; ?>/Subscribers/viewActiveSubscribers">Active Subscriber</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT; ?>/Subscribers/viewDeactiveSubscribers">De-Active
                                Subscriber</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT; ?>/Subscribers/viewSubscribersByLocation">Location Wise
                                Subscriber</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT; ?>/Subscribers/viewSubscribersByPackage">Package Wise
                                Subscriber</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="has-sub">
                    <a class="js-arrow">
                        <i style="width: 20px" class="fas fa-coins"></i>Package<span class="fa fa-chevron-down"
                                                                                     style="float: right;padding-right: 14px;"></span></a>
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        <li>
                            <a href="<?php echo URLROOT; ?>/Packages/index">View Package</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT; ?>/Packages/add">Add Package</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="has-sub">
                    <a class="js-arrow">
                        <i style="width: 20px" class="fa fa-map-marker-alt"></i>Location<span class="fa fa-chevron-down"
                                                                                              style="float: right;padding-right: 14px;"></span></a>
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        <li>
                            <a href="<?php echo URLROOT; ?>/locations/index">View Location</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT; ?>/locations/add">Add Location</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="has-sub">
                    <a class="js-arrow">
                        <i style="width: 20px" class="fas fa-dollar-sign"></i>Accounts<span class="fa fa-chevron-down"
                                                                                            style="float: right;padding-right: 14px;"></span></a>
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        <li class="has-sub">
                        ...
                        <li class="has-sub">
                            <a class="" href="<?php URLROOT; ?>/accounts/payments/mySubscribers">
                                <i></i>My Subscribers</a>
                        </li>
                        <li class="has-sub">
                        ...
                        <li class="has-sub">
                            <a class="" href="<?php URLROOT; ?>/accounts/reports/index">
                                <i></i>Monthly Report</a>
                        </li>
                        <li class="has-sub">
...
<script>
    $(document).ready(function () {
        ...
        var checkUrl = tempUrl.substring(1)+'/index';
        $('ul.nav-left a').filter(function () {
            if (this.href==url[0])
            {
                return true
            }
            else if(this.href==checkUrl)
            {
                return true
            }
            else {
